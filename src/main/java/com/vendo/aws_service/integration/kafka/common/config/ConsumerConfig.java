package com.vendo.aws_service.integration.kafka.common.config;
...
public class ConsumerConfig {
    ...
    public CommonErrorHandler errorHandler() {
        ...
        errorHandler.addNotRetryableExceptions(AwsEventHandlerNotFoundException.class);
        errorHandler.addNotRetryableExceptions(AwsEventDeserializationException.class);
