...
public class StorageControllerIntegrationTest {
    ...
    class PresignedTests {
        ...
        void presigned_shouldReturnPresignedUrl() throws Exception {
            ...
            ArgumentCaptor<PresignedFile> presignedFileCaptor = ArgumentCaptor.forClass(PresignedFile.class);
            ...
            assertThat(presignedFile.key()).isEqualTo(presignedBody.key());
            assertThat(presignedFile.contentType()).isEqualTo(file.contentType());
            assertThat(presignedFile.size()).isEqualTo(file.size());
        }
